<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            Reserve # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            Reserve
        </v-card-title >
        ...
        <v-card-text>
            <String label="MovieName" v-model="value.movieName" :editMode="editMode"/>
            <String label="MovieId" v-model="value.movieId" :editMode="editMode"/>
